...
// solo para  el intent "confirma_pedido" --> heiloandinobot
function obtener_variables_ext()
{
    global $input;
...
// obtener descripcion del pedido desde otro intend
function obtener_variables_ped()
{
    global $input;
    if (isset($input["queryResult"]["outputContexts"][0]["parameters"])) {
        return $input["queryResult"]["outputContexts"][0]["parameters"];
...
function enviar_varios_textos($textos)
{
  $str = "";
  echo '{"fulfillmentMessages":[';
