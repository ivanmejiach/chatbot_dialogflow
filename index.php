      ...
      <div class="row">
        <div class="col-md-4">
          <div class="pricing-box">
            <h3 class="demo">Helado big fruits</h3>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRlTqoAgpcUEGfC4W1nUAfqi2Rc4Y1kPj086R-vAaub28WwUv7z&usqp=CAU" style="width:100%" alt="">
            <h6>CARNE</h6>
            <small>forever</small>
            <p>Stock: <?php echo consulta_stock('carne'); ?> unidades</p>
        ...
        <div class="col-md-4">
          <div class="pricing-box">
            <h3 class="demo">Tres sabores</h3>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTHIwtfWsztW4HgV7yOVq6l3jhH1L5CS1Cf6dkrSr4ITPx6W0OZ&usqp=CAU" style="width:100%;" alt="">
            <h6>CHOCLO</h6>
            <small>forever</small>
            <p>Stock: <?php echo consulta_stock('choclo'); ?> unidades</p>
            <div class="divider-light"></div>
            <ul>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Carne Vacuna</li>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Cebolla</li>
        ...
        <div class="col-md-4">
          <div class="pricing-box">
            <h3 class="demo">Helado Artesanal</h3>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcShn2wapUVAe2ib1SSm7wQK_fWlgylYUb01KvBun_srrJi9ii3x&usqp=CAU" style="width:100%" alt="">
            <h6>ARABES</h6>
            <small>forever</small>
            <p>Stock: <?php echo consulta_stock('arabes'); ?> unidades</p>
            <div class="divider-light"></div>
            <ul>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Carne Vacuna</li>
              <li><i class="icon ion-md-checkmark-circle-outline demo"></i>Cebolla</li>
